$(document).ready(function() {
	...
	$("#breadcrumb").Breadcrumb({
		PageName : "FundSearchInFundAttribut"
	});
...
{	
	...
	{
		type:"GET",
		url: "../Dienste/Fund/Get/FundAttribut/" + node.id,
		dataType: "JSON",
		success:function(data, textStatus, jqXHR)
		{	
		...
		{
			console.log("FEHLER: \"../Dienste/Fund/Get/FundAttribut/" + node.id + "\" konnte nicht geladen werden!");
			$("*").css("cursor", "default");
		}
	});
}
