(function($)
{
	$.fn.FilteredMultiDropdown = function(options)
	{
		return this.each(function()
		{
			LoadFilteredMultiDropdown(options, "#"+this.id, options.SelectedElementId);
		});
	}
	
	function LoadFilteredMultiDropdown(options, containerSelector, elementId)
	{	
	...
	function RegisterSelectionChangeEvent(options, containerSelector, level)
	{
		...
		$(selectSelector).change(function() {
			...
			LoadFilteredMultiDropdown(options, containerSelector, value);
		});
	}
