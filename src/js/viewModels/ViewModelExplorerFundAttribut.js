var ViewModelExplorerFundAttribut = function (webServiceClient) {
	...
	this._createAbstractRoot = function () {
		...
		abstractRoot.Bezeichnung = "Fundattribut";
		abstractRoot.Path = "/";
...
ViewModelExplorerFundAttribut.prototype = new ViewModelExplorer();