...
function setIdToEditLink(id) {
    $("#buttonEdit").attr("href", "/pages/FundAttributType/Form.html?Id=" + id);
}
...
function EnableButtonNew() {
	...
	$("#buttonNew").click(function () {
		...
		window.open("/pages/FundAttributType/Form.html", "_self");
	});
...
function EnableButtonEdit() {
	...
	$("#buttonEdit").click(function () {
		...
		window.open("/pages/FundAttributType/Form.html?Id=" + _viewModelListFundAttributType.getSelectedItem().Id, "_self");
	});
