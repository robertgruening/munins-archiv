...
function EnableButtonNew(id) {
	if (id === undefined ||
		id === null) {
		$("#buttonNew").attr("href", "/pages/Ort/Form.html");
	}
	else {
		$("#buttonNew").attr("href", "/pages/Ort/Form.html?Parent_Id=" + id);
	}
...
function EnableButtonOpen(args) {
	if (args.SelectedItem.Id === undefined) {
		$("#buttonOpen").attr("href", "/pages/Ort/Explorer.html");
	}
	else {
		$("#buttonOpen").attr("href", "/pages/Ort/Explorer.html?Id=" + args.SelectedItem.Id);
	}
...
function EnableButtonEdit(args) {
	if (args.SelectedItem.Id === undefined) {
		$("#buttonEdit").attr("href", "/pages/Ort/Form.html");
	}
	else {
		$("#buttonEdit").attr("href", "/pages/Ort/Form.html?Id=" + args.SelectedItem.Id);
	}
...
function EnableButtonOpenParent(parent) {
	...
	if (parent.Id === undefined) {
		$("#buttonOpenParent").attr("href", "/pages/Ort/Explorer.html");
	}
	else {
		$("#buttonOpenParent").attr("href", "/pages/Ort/Explorer.html?Id=" + parent.Id);
	}
...
function EnableButtonOpenAbstractRoot(parent) {
	...
	$("#buttonOpenAbstractRoot").attr("href", "/pages/Ort/Explorer.html");
...
function InitGrid()
{
    ...
    $("#grid").jsGrid({
		...
		rowDoubleClick: function(args) {
			...
			window.open("/pages/Ort/Explorer.html?Id=" + args.item.Id, "_self");
		}
    });
}
