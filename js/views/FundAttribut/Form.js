...
function setParent(parent) {
	...
	linkParent.attr("href", "../../pages/FundAttribut/Form.html?Id=" + parent.Id);
...
function removeParent() {
	_viewModelFormFundAttribut.removeParent();
}
...
function EnableButtonToOverview(parent) {
	if (parent === undefined ||
		...
		parent.Id === undefined) {
			...
			$("#buttonToOverview").attr("href", "/pages/FundAttribut/Explorer.html", "_self");
		}
		else {
			$("#buttonToOverview").attr("href", "/pages/FundAttribut/Explorer.html?Id=" + parent.Id, "_self");
		}
