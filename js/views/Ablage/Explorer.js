...
function InitButtonNew() {
	EnableButtonNew();
	$("#buttonNew").attr("href", "/pages/Ablage/Form.html");
}
...
function EnableButtonNew(id) {
	if (id === undefined ||
		...
		$("#buttonNew").attr("href", "/pages/Ablage/Form.html?Parent_Id=" + id);
	}
...
function EnableButtonOpen(args) {
	if (args.SelectedItem.Id === undefined) {
		$("#buttonOpen").attr("href", "/pages/Ablage/Explorer.html");
	}
	else {
		$("#buttonOpen").attr("href", "/pages/Ablage/Explorer.html?Id=" + args.SelectedItem.Id);
	}
...
function EnableButtonEdit(args) {
	if (args.SelectedItem.Id === undefined) {
		$("#buttonEdit").attr("href", "/pages/Ablage/Form.html");
	}
	else {
		$("#buttonEdit").attr("href", "/pages/Ablage/Form.html?Id=" + args.SelectedItem.Id);
	}
...
function EnableButtonOpenParent(parent) {
	...
	if (parent.Id === undefined) {
		$("#buttonOpenParent").attr("href", "/pages/Ablage/Explorer.html");
	}
	else {
		$("#buttonOpenParent").attr("href", "/pages/Ablage/Explorer.html?Id=" + parent.Id);
	}
...
function EnableButtonOpenAbstractRoot(parent) {
	...
	$("#buttonOpenAbstractRoot").attr("href", "/pages/Ablage/Explorer.html");
...
function InitButtonScan() {
	$("#buttonScan").attr("href", "/pages/Ablage/Scan.html");
}
//#endregion

//#region print labels
function InitButtonPrintLabels() {
	$("#buttonPrintLabels").attr("href", "/pages/Ablage/PrintLabels.html");
}
//#endregion
//#endregion
...
function InitGrid()
{
    ...
    $("#grid").jsGrid({
		...
		rowDoubleClick: function(args) {
			...
			window.open("/pages/Ablage/Explorer.html?Id=" + args.item.Id, "_self");
		}
    });
}
