...
if (id === undefined ||
	id === null) {
		...
		$("#buttonNew").attr("href", "/pages/" + getChildKontextTypeBezeichnung(_viewModelExplorerKontext.getType()) + "/Form.html");
	}
	else {
		$("#buttonNew").attr("href", "/pages/" + getChildKontextTypeBezeichnung(_viewModelExplorerKontext.getType()) + "/Form.html?Parent_Id=" + id);
	}
...
function EnableButtonOpen(args) {
	if (args.SelectedItem.Id === undefined) {
		$("#buttonOpen").attr("href", "/pages/Kontext/Explorer.html");
	}
	else {
		$("#buttonOpen").attr("href", "/pages/Kontext/Explorer.html?Id=" + args.SelectedItem.Id);
	}
...
function EnableButtonEdit(args) {
	if (args.SelectedItem.Id === undefined) {
		$("#buttonEdit").attr("href", "/pages/" + getChildKontextTypeBezeichnung(_viewModelExplorerKontext.getType()) + "/Form.html");
	}
	else {
		$("#buttonEdit").attr("href", "/pages/" + getChildKontextTypeBezeichnung(_viewModelExplorerKontext.getType()) + "/Form.html?Id=" + args.SelectedItem.Id);
	}
...
function EnableButtonOpenParent(parent)
{
	...
	if (parent.Id === undefined) {
		$("#buttonOpenParent").attr("href", "/pages/Kontext/Explorer.html");
	}
	else {
		$("#buttonOpenParent").attr("href", "/pages/Kontext/Explorer.html?Id=" + parent.Id);
	}
...
function EnableButtonOpenAbstractRoot(parent)
{
	...
	$("#buttonOpenAbstractRoot").attr("href", "/pages/Kontext/Explorer.html");
...
function InitButtonToMap() {
	$("#buttonToMap").attr("href", "/pages/Fundstelle/Map.html", "_self");
}
//#endregon
//#endregion
...
function InitGrid()
{
	...
	$("#grid").jsGrid({
		...
		rowDoubleClick: function(args) {
			...
			window.open("/pages/Kontext/Explorer.html?Id=" + args.item.Id, "_self");
		}
	});
}
